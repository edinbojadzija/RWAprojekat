...
@WebServlet("/Editor/EditorEdit")
public class EditorInfoServlet extends HttpServlet {
   ...
   UserService user = null;
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		PrintWriter out=response.getWriter();
				...
				out.println("<button class='ui button center floated'><a href='/rwaprojekat/Editor/EditInfoQuiz?id=" + nameQuiz +  " '>EDIT QUIZ INFO</a></button>");
				out.println("<button class='ui button center floated'><a href='/rwaprojekat/Editor/AddQuizQuestion?id=" + nameQuiz + "'>ADD NEW QUESTION</a></button>");
				out.println("<button class='ui button center floated'><a href='/rwaprojekat/Editor/Question?id=" + nameQuiz + "'>QUESTIONS</a></button>");
