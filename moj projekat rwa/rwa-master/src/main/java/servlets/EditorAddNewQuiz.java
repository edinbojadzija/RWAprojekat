...
@WebServlet("/Editor/NewQuiz")
public class EditorAddNewQuiz extends HttpServlet {
private static final long serialVersionUID = 1L;

   QuizService quiz = null;
   Quiz novi = null;
   String owner = null; 
   public EditorAddNewQuiz()
   {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		owner = (String) request.getSession().getAttribute("user");
		...
		String css2= "<link rel='stylesheet' type='text/css' href='css/admin.css'>";
				...
				out.print("<form action='/rwaprojekat/Editor/NewQuiz' method='post'>");
				...
				out.print("<tr><td><div class='ui label'>OWNER NAME:</div></td><td><div class='ui input'><input type='text' style='width:500px;' name='ownername' value='" + owner  + "'</div></td></tr>");
				out.print("</td></tr>");
				out.print("<tr><td colspan='2'><button class='ui button right floated' type='submit'>SAVE</button><button class='ui button right floated cancel'><a href='/rwaprojekat/admin' id='cancel'>CANCEL</a></td></button></td></tr>");
				out.print("</table>");
				out.print("</form>");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("Username: " + namequiz + "\t Password: " + description + "\t Position: " + activestatus + "\t Owner: " + ownername);
