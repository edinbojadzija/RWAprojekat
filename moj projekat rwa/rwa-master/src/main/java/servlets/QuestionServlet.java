...
public class QuestionServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<button class='ui button center floated'><a href='/rwaprojekat/admin'>BACK</a></button>");
		...
		for(Question v:listaPitanja){
			out.print("<tr><td><div class='ui label admin'>"+v.getName()+"</div></td><td><div class='ui label admin'>" + v.getTime() +"</div></td>"
					...
					+ "<td><a href='/rwaprojekat/admin/QuestionEdit?id="+v.getName()+"'>"
					+ "<i class='edit icon'></i>"
					+ "<td><a href='/rwaprojekat/admin/QuestionDelete?id="+v.getName()+"'>"
