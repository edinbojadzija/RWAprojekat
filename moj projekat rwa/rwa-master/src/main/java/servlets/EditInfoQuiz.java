...
@WebServlet("/admin/EditInfoQuiz")
public class EditInfoQuiz extends HttpServlet {
   ...
   Quiz novi = null;
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String css2= "<link rel='stylesheet' type='text/css' href='css/admin.css'>";
			    ...
			    out.println("<html>");
			    out.println("<head><title>EDIT INFO QUIZ</title>"+css+ css2 + "</head>");
				...
				out.print("<form action='/rwaprojekat/admin/EditInfoQuiz' method='post'>");
				...
				out.print("</td></tr>");
				out.print("<tr><td colspan='2'><button class='ui button right floated' type='submit'>EDIT</button><button class='ui button right floated cancel'><a href='/rwaprojekat/admin' id='cancel'>CANCEL</a></td></button></td></tr>");
				out.print("</table>");
				out.print("</form>");
