...
@WebServlet("/Editor/QuestionEdit")
public class EditorQuestionEdit extends HttpServlet {
   ...
   public EditorQuestionEdit()
   {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String css2= "<link rel='stylesheet' type='text/css' href='css/admin.css'>";
				...
				out.print("<form action='/rwaprojekat/Editor/QuestionEdit' method='post'>");
				...
				out.print("</td></tr>");
				out.print("<tr><td colspan='2'><button class='ui button right floated' type='submit'>SAVE</button><button class='ui button right floated cancel'><a href='/rwaprojekat/Editor'>CANCEL</a></td></button></td></tr>");
				out.print("</table>");
				out.print("</form>");
